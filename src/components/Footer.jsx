...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#54ad95] text-[#0a0a0a] font-bold text-sm md:text-base">
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex items-center space-x-3">
              <Link to="/" className="flex items-center">
                ...
                <div className="hidden md:flex flex-col ml-3 leading-none">
                  <span className="text-lg md:text-xl font-extrabold text-[#060505] tracking-wide">Dental Avenue</span>
                  <span className="text-xs text-[#060505]">Advanced Dental Care</span>
                </div>
              </Link>
            </div>
            <p className="text-sm text-[#060505] leading-relaxed">
          ...
          {/* Services Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-[#060505]">Services</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-sm text-[#060505]">{footerLinks.contact.phone}</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#88d4cb]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-sm text-[#060505]">{footerLinks.contact.email}</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#88d4cb]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm text-[#060505]">{footerLinks.contact.hours}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-[#e0ddd9]">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-[#060505]">
              © {currentYear} 32 Dental Avenue. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link to="/privacy" className="text-sm text-[#060505] hover:text-[#424040] transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="text-sm text-[#060505] hover:text-[#424040] transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
      </div>
